...
<div class="content">
    ...
    <div class="nav">
                <ul>
                    <li><a href="#">Flash Web Templates</a></li>
                    <li><a href="#">Blog Web Templates</a></li>
                    <li><a href="#">Mobile Web Templates</a></li>
                    <li><a href="#">More</a></li>
                </ul>
            </div>
	<div class="main">
...
<div id="bg_footer">	
    ...
    <div class="clear"></div>
    <div class="copy">Copyright &copy; 2015.Company name All rights reserved.<a target="_blank" href="http://sc.chinaz.com/moban/"></a></div>
</div>
</div>
</body>
</html>
